...
export const logs_enrichissement = pgTable("logs_enrichissement", {
...
export const identifiantIdx = index("idx_logs_enrichissement_identifiant").on(
  logs_enrichissement.identifiantCadastral,
);
export const statutIdx = index("idx_logs_enrichissement_statut").on(logs_enrichissement.statut);
export const dateIdx = index("idx_logs_enrichissement_date").on(
  logs_enrichissement.dateEnrichissement,
);
