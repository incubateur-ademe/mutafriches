...
- **Évaluation de mutabilité** sur 7 usages (résidentiel, équipements, culture, tertiaire, industrie, renaturation, photovoltaïque) à partir d'une matrice 28 critères × 7 usages
...
export function buildSwaggerConfig() {
  ...
  return builder
    ...
    .addTag("evaluation", "Calcul de mutabilité sur 7 usages (matrice 28 critères × 7 usages)")
