...
export const API_MONITORING_ENTRIES: readonly ApiMonitoringEntry[] = [
  ...
  },
  {
    ...
    name: "IGN WFS — BDTOPO",
    category: "Transport",
    description: "Tronçons autoroutiers et bretelles (accès autoroutiers)",
    docUrl: "https://geoservices.ign.fr/services-web-essentiels",
  ...
  {
    key: "ign-itineraire",
    name: "IGN — Calcul d'itinéraire",
    category: "Transport",
    description: "Distance par la route jusqu'à l'accès autoroutier le plus proche",
    docUrl: "https://geoservices.ign.fr/documentation/services/services-geoplateforme/itineraire",
    adapterFile: "apps/api/src/enrichissement/adapters/ign-itineraire/ign-itineraire.service.ts",
    baseUrl: "https://data.geopf.fr/navigation/itineraire",
    healthCheckMethod: "GET",
    healthCheckUrl: "https://data.geopf.fr/navigation/getcapabilities",
  },
  {
    key: "zaer-wfs",
    name: "IGN WFS — ZAER",
