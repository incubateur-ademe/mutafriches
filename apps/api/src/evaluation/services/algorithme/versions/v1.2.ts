/**
 * Version 1.2 - Zone urba
 * Configuration extraite de l'état entre b8c3f1d et 00afa21
 * Différences avec v1.1 :
 *   - Ajout sous-catégories U (U_HABITAT, U_EQUIPEMENT, U_ACTIVITE)
 *   - ZONE_A_URBANISER_AU RENATURATION = NEUTRE (au lieu de NEGATIF)
 *   - ZONE_VOCATION_ACTIVITES TERTIAIRE = POSITIF (au lieu de NEGATIF)
 * Différences avec v1.2 :
 *   - Risque naturel unique (presenceRisquesNaturels) au lieu de 3 critères séparés
 *   - Pas de ZAER (zoneAccelerationEnr)
 */
