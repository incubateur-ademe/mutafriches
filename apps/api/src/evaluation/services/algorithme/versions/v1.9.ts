/**
 * Version 1.9 - v1.7 + corrections PV (raccordement BT/HT, autoroute, PLU, état bâti).
 * Copie statique figée : ne dépend plus de la configuration courante, qui a divergé
 * à partir de v1.11 (réactivation du critère distanceIte).
 */
