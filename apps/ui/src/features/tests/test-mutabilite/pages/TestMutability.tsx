...
export function TestMutability() {
  ...
  const handleTestCaseSelect = (testCase: TestCase | null) => {
    ...
    if (testCase) {
      ...
      const flatFormData = {
        ...
        risqueRetraitGonflementArgile: testCase.input.risqueRetraitGonflementArgile,
        risqueCavitesSouterraines: testCase.input.risqueCavitesSouterraines,
        risqueInondation: testCase.input.risqueInondation,
  ...
  const handleCalculate = async () => {
    ...
    try {
      ...
      const result = await evaluationService.calculerMutabilite(dataToSend, {
        modeDetaille: true,
