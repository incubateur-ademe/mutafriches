      ...
      <div className="content-editorial fr-col-12">
        ...
        <div className="fr-callout fr-callout--brown-cafe">
          ...
          <p className="fr-callout__text">
            Ces pages de test sont destinées au développement et à la validation. Elles permettent
            de vérifier le bon fonctionnement des différentes parties de l'application.
          </p>
        </div>
      </div>
    </Layout>
