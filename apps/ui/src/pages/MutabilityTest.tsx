...
export default function MutabilityTest() {
      ...
      <div className="fr-grid-row">
        <div className="fr-col-12">
          ...
          <div className="fr-alert fr-alert--info fr-mb-4w">
            <p>
              Cette page permet de tester l'algorithme de calcul de mutabilité avec des cas de test
              prédéfinis ou en saisissant manuellement les données d'une friche.
            </p>
          </div>
