...
| `raccordementEau` | 1 | Dérivé automatiquement de `surfaceBati` (>20m² => OUI, ≤20 => NON, indisponible => NE_SAIT_PAS). Reste structurellement dans `DonneesComplementairesInputDto` mais la valeur saisie est écrasée. |
