...
export class MutabilityResultDto {
  ...
  @ApiProperty({
    description:
      'Résultats détaillés pour chaque usage, classés par potentiel décroissant',
    type: [UsageResultDto],
    example: [
      {
        rang: 7,
      ...
      },
      {
        ...
        explication:
          'Bonne accessibilité et superficie adaptée pour équipements collectifs.',
        indiceMutabilite: 63,
        potentiel: 'Favorable',
      },
      {
        ...
        usage: 'Tertiaire',
        explication:
          'Desserte correcte mais concurrence forte en centre-ville.',
        indiceMutabilite: 60,
        potentiel: 'Modéré',
      },
      {
        ...
        explication:
          'Valeur patrimoniale exceptionnelle compensant les contraintes techniques.',
        indiceMutabilite: 56,
        potentiel: 'Modéré',
      },
      {
        ...
        usage: 'Industrie',
        explication:
          "Contraintes d'accessibilité et proximité résidentielle limitantes.",
        indiceMutabilite: 54,
      ...
      },
      {
        ...
        explication:
          'Exposition correcte mais surface partiellement occupée par du bâti.',
        indiceMutabilite: 47,
        potentiel: 'Peu favorable',
      },
      {
        ...
        usage: 'Renaturation',
        explication:
          'Site imperméabilisé nécessitant des travaux lourds de dépollution.',
        indiceMutabilite: 41,
